...
@FacesValidator("com.fl.tools.ui.validators.ProfileDomainObjectsValidator")
public class ProfileDomainObjectsValidator implements Validator {
	...
	public void validate(FacesContext context, UIComponent component, Object value) throws ValidatorException {
		...
		try {
			...
			throw new ValidatorException(new FacesMessage("Error reading domain objects file:" + e.getMessage()));
		}
